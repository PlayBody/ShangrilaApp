...
String apiLoadDayStampCntUrl = apiBase + '/apicoupons/loadDayStampCount';
...
String floorImageUrl = apiBase + '/assets/images/floors/';
String apiNewSaleUrl = apiNewBase + '/sales/isNewSaleNews';
